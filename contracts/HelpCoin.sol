...
/**
 * @title HelpCoin ERC20 token
 * @dev This is part of an implementation of the HelpCoin Ideal Money protocol.
 *      HelpCoin is a normal ERC20 token, but its supply can be adjusted by splitting and
